...
describe('Canonical Liquidation Order', () => {
  ...
  it('should verify canonical instruction sequence structure', () => {
    ...
    expect(canonicalOrder[4]).toBe('PRE: RefreshFarms (0-2, if exist)');
  ...
  it('should verify error codes fixed by canonical order', () => {
    ...
    const fixedErrors = {
      ...
      'Custom(6051)': {
        ...
        fix: 'PRE farms refresh immediately before liquidation satisfies check_refresh adjacency',
      },
    };
